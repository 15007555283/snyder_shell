...
case "${Stack}" in
    ...
    lamp)
        ...
        ;;
    php)
        Dispaly_PHP_Selection
        PHP_Stack 2>&1 | tee /root/php-install.log
        ;;
    nginx)
    ...
    mphp)
        ...
        ;;
    *)
        Echo_Red "Usage: $0 {lnmp|lnmpa|lamp|php}"
        Echo_Red "Usage: $0 {nginx|db|mphp|php}"
        ;;
esac
